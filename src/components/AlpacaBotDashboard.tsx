    ...
    return {
      ...
      "2026-08": {
        ...
        days: {
          ...
          "2026-08-05": { trades: [{ id: "a5_1", symbol: "AMD", name: "AMD", time: "09:34 AM", contract: "AMD $160C", entryAsk: 1.85, t1Target: 2.40, t2Target: 2.96, stopLoss: 1.40, peakPrice: 1.45, outcome: "STOPPED", pnlPerContract: -45.0, percentGain: "-24.3%", catalyst: "Client PC Growth In-Line", rvol: "2.4x", invalidationNote: "Client PC growth in-line; lost ORB shelf ($159.20)" }] },
          ...
          "2026-08-12": { trades: [{ id: "a12_1", symbol: "TSLA", name: "Tesla", time: "09:34 AM", contract: "TSLA $360C", entryAsk: 2.90, t1Target: 3.77, t2Target: 4.64, stopLoss: 2.20, peakPrice: 2.30, outcome: "STOPPED", pnlPerContract: -70.0, percentGain: "-24.1%", catalyst: "Energy Storage GWh Deployments", rvol: "2.2x", invalidationNote: "Energy storage sell-the-news flush" }] },
      ...
      "2026-07": {
        ...
        days: {
          ...
          "2026-07-07": { trades: [{ id: "j7_1", symbol: "PANW", name: "Palo Alto", time: "09:34 AM", contract: "PANW $340C", entryAsk: 1.80, t1Target: 2.34, t2Target: 2.88, stopLoss: 1.38, peakPrice: 1.85, outcome: "STOPPED", pnlPerContract: -42.0, percentGain: "-23.3%", catalyst: "Platformization Deals Update", rvol: "2.2x", invalidationNote: "Choppy range, lost ORB Low shelf" }] },
          ...
          "2026-07-27": { trades: [{ id: "j27_1", symbol: "PANW", name: "Palo Alto", time: "09:31 AM", contract: "PANW $348C", entryAsk: 1.85, t1Target: 2.40, t2Target: 2.96, stopLoss: 1.41, peakPrice: 1.90, outcome: "STOPPED", pnlPerContract: -44.0, percentGain: "-23.8%", catalyst: "Enterprise Network Security Deal", rvol: "2.2x", invalidationNote: "Failed breakout extension, stopped at ORB shelf" }] },
