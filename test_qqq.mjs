// We need to compile TS to JS or just use tsx/ts-node.
// Since Next.js handles it, let's just write a plain JS script.
...
async function testQQQ() {
    ...
    const historical = await yahooFinance.historical("QQQ", {
        period1: startDate,
        period2: endDate,
        interval: '1d'
    });
